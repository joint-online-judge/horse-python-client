...
class UserApi(object):
    ...
    def v1_get_current_user_problems(self, **kwargs):  # noqa: E501
        """Get Current User Problems  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_get_current_user_problems(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v1_get_current_user_problems_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.v1_get_current_user_problems_with_http_info(**kwargs)  # noqa: E501
            return data

    def v1_get_current_user_problems_with_http_info(self, **kwargs):  # noqa: E501
        """Get Current User Problems  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_get_current_user_problems_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_get_current_user_problems" % key
                )
            params[key] = val
        del params['kwargs']
