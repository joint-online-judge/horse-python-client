...
class JudgeApi(object):
    ...
    def v1_submit_case_by_judger(self, body, case, domain, record, **kwargs):  # noqa: E501
        """Submit Case By Judger  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_submit_case_by_judger(body, case, domain, record, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v1_submit_case_by_judger_with_http_info(body, case, domain, record, **kwargs)  # noqa: E501
        else:
            (data) = self.v1_submit_case_by_judger_with_http_info(body, case, domain, record, **kwargs)  # noqa: E501
            return data

    def v1_submit_case_by_judger_with_http_info(self, body, case, domain, record, **kwargs):  # noqa: E501
        """Submit Case By Judger  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_submit_case_by_judger_with_http_info(body, case, domain, record, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'case', 'domain', 'record']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
