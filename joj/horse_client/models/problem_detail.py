...
class ProblemDetail(object):
    ...
    def __init__(self, id=None, domain_id=None, url='', title=None, hidden=False, content='', num_submit=0, num_accept=0, owner_id=None, problem_group_id=None, created_at=None, updated_at=None):  # noqa: E501
