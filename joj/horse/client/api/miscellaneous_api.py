...
class MiscellaneousApi(object):
    ...
    def jwt_api_v1_jwt_get(self, **kwargs):  # noqa: E501
        """Jwt  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.jwt_api_v1_jwt_get(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.jwt_api_v1_jwt_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.jwt_api_v1_jwt_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def jwt_api_v1_jwt_get_with_http_info(self, **kwargs):  # noqa: E501
        """Jwt  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.jwt_api_v1_jwt_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method jwt_api_v1_jwt_get" % key
                )
            params[key] = val
        del params['kwargs']
