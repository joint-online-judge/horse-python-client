...
class Problem(object):
    ...
    def __init__(self, id=None, domain_id=None, url='', title=None, content='', hidden=False, num_submit=0, num_accept=0, data_version=2, languages='[]', owner_id=None, problem_group_id=None):  # noqa: E501
