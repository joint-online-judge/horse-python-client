# horse-python-client
Git version: dad896a@2021-06-08 19:53:00
...
*ProblemApi* | [**clone_problem_api_v1_problems_clone_post**](docs/ProblemApi.md#clone_problem_api_v1_problems_clone_post) | **POST** /api/v1/problems/clone | Clone Problem
*ProblemApi* | [**create_problem_api_v1_problems_post**](docs/ProblemApi.md#create_problem_api_v1_problems_post) | **POST** /api/v1/problems | Create Problem
*ProblemApi* | [**delete_problem_api_v1_problems_problem_delete**](docs/ProblemApi.md#delete_problem_api_v1_problems_problem_delete) | **DELETE** /api/v1/problems/{problem} | Delete Problem
*ProblemApi* | [**get_problem_api_v1_problems_problem_get**](docs/ProblemApi.md#get_problem_api_v1_problems_problem_get) | **GET** /api/v1/problems/{problem} | Get Problem
*ProblemApi* | [**list_problems_api_v1_problems_get**](docs/ProblemApi.md#list_problems_api_v1_problems_get) | **GET** /api/v1/problems | List Problems
*ProblemApi* | [**submit_solution_to_problem_api_v1_problems_problem_post**](docs/ProblemApi.md#submit_solution_to_problem_api_v1_problems_problem_post) | **POST** /api/v1/problems/{problem} | Submit Solution To Problem
*ProblemApi* | [**update_problem_api_v1_problems_problem_patch**](docs/ProblemApi.md#update_problem_api_v1_problems_problem_patch) | **PATCH** /api/v1/problems/{problem} | Update Problem
