...
class TestDomainApi(unittest.TestCase):
    ...
    def test_search_domain_candidates_api_v1_domains_domain_candidates_get(self):
        """Test case for search_domain_candidates_api_v1_domains_domain_candidates_get
